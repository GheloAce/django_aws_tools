...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bounce'
        db.create_table('django_aws_tools_bounces', (
        ...
        db.send_create_signal(u'django_aws_tools', ['Bounce'])

        # Adding model 'Complaint'
        db.create_table('django_aws_tools_complaints', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('sns_topic', self.gf('django.db.models.fields.CharField')(max_length=350)),
        ...
        db.send_create_signal(u'django_aws_tools', ['Complaint'])


    def backwards(self, orm):
        # Deleting model 'Bounce'
        db.delete_table('django_aws_tools_bounces')

        # Deleting model 'Complaint'
        db.delete_table('django_aws_tools_complaints')
